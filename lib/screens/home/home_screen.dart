...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      homeProvider.loadRecentContacts();
    });
    ...
    _mainScrollController.addListener(() {
      ...
      if (_mainScrollController.hasClients) {
        Provider.of<HomeProvider>(context, listen: false)
            .setScrollPosition(_mainScrollController.position.pixels);
      }
    });
  ...
  Widget build(BuildContext context) {
    final homeProvider = Provider.of<HomeProvider>(context); // Get the HomeProvider for the context and listen for changes
    final mediaQuery = MediaQuery.of(context); // Get the MediaQuery for the context
                          ...
                          children: [
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: isDepartmentSearch
                                        ? homeProvider.selectedDepartment!= 'Select Department' ? 'Search in ${homeProvider.selectedDepartment!}' : 'Select Department'
                                        : "Search contacts",
                            ...
                            if (searchController.text.isNotEmpty)
                              ...
                              onPressed: () {
                                ...
                                homeProvider.updateSearchQuery('');
                                if (isDepartmentSearch) {
                                homeProvider.updateSearchResultsForDepartment(
                ...
                child: NotificationListener<ScrollNotification>(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      int adjustedIndex = isSearchVisible &&
                              homeProvider.searchQuery.isEmpty &&
                              homeProvider.selectedDepartment ==
                                  'Select Department'
                          ? index - 1
                              ...
                              children: [
                                ListTile(
                                  ...
                                  leading: contact.photo != null
                                      ? _buildAvatar(
                                          contact.photo!, contact.firstName!)
                                      : CircleAvatar(
                                          backgroundColor:
                                  ...
                                  onTap: () {
                                    if (!isSearchVisible) {
                                      ...
                                      setState(() {
                                        if (selectedSearchContactIndex ==
                                            adjustedIndex) {
                                          isMenuVisible = !isMenuVisible;
                                        } else {
                                          selectedSearchContactIndex =
                                              adjustedIndex;
                                          isMenuVisible = true;
                                        }
                                      });
